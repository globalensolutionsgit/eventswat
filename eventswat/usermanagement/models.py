...
class Userprofile(User):
	...
	user_type=models.CharField(max_length=50, null=True, blank=True, choices=USER_TYPE_CHOICES)
	profile_pic = models.ImageField(upload_to='profile',null=True, blank=True, max_length=500)
