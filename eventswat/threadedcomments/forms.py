...
class ThreadedCommentForm(CommentForm):
    title = forms.CharField(label=_('Title'), required=True, max_length=getattr(settings, 'COMMENTS_TITLE_MAX_LENGTH', 255))
    parent = forms.IntegerField(required=False, widget=forms.HiddenInput)
    # postevent = forms.IntegerField(required=False, widget=forms.HiddenInput)
    ...
    def get_comment_create_data(self):
        ...
        # d['postevent'] = self.cleaned_data['postevent']
        return d
