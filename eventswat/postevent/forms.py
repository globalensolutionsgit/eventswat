...
from postevent.models import (Postevent, SubCategoryRelatedFieldValue,
                              Organizer, PosteventPoster)
...
class PosteventForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['event_type', 'event_category', 'event_subcategory',
                  ...
                  'event_enddate_time', 'terms_and_condition',
...
class PosteventPosterForm(forms.ModelForm):

    class Meta:
        model = PosteventPoster
        exclude = ['postevent', 'event_poster_thumbnil', 'event_poster_medium']
