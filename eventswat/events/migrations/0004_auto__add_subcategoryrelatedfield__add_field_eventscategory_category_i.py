...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubcategoryRelatedField'
        db.create_table(u'events_subcategoryrelatedfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'events', ['SubcategoryRelatedField'])

        # Adding M2M table for field related_subcategory on 'SubcategoryRelatedField'
        m2m_table_name = db.shorten_name(u'events_subcategoryrelatedfield_related_subcategory')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subcategoryrelatedfield', models.ForeignKey(orm[u'events.subcategoryrelatedfield'], null=False)),
            ('eventssubcategory', models.ForeignKey(orm[u'events.eventssubcategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['subcategoryrelatedfield_id', 'eventssubcategory_id'])

        # Adding field 'EventsCategory.category_icon'
        db.add_column(u'events_eventscategory', 'category_icon',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'EventsCategory.category_hover_icon'
        db.add_column(u'events_eventscategory', 'category_hover_icon',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SubcategoryRelatedField'
        db.delete_table(u'events_subcategoryrelatedfield')

        # Removing M2M table for field related_subcategory on 'SubcategoryRelatedField'
        db.delete_table(db.shorten_name(u'events_subcategoryrelatedfield_related_subcategory'))

        # Deleting field 'EventsCategory.category_icon'
        db.delete_column(u'events_eventscategory', 'category_icon')

        # Deleting field 'EventsCategory.category_hover_icon'
        db.delete_column(u'events_eventscategory', 'category_hover_icon')
