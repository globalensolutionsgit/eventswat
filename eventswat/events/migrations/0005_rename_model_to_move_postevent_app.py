...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('events_college', 'postevent_campuscollege') 
        db.rename_table('events_department', 'postevent_campusdepartment')
        db.rename_table('events_collegedepartment_college', 'postevent_campusdepartment_college')

    def backwards(self, orm):
        db.rename_table('postevent_campuscollege', 'events_college') 
        db.rename_table('postevent_campusdepartment', 'events_department')
        db.rename_table('postevent_campusdepartment_college', 'events_collegedepartment_college')
    ...
    models = {
        ...
        u'events.collegedepartment': {
            ...
            'college': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['events.CampusCollege']", 'null': 'True', 'symmetrical': 'False'}),
            'department': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['events.CampusDepartment']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
